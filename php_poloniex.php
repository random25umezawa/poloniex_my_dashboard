<?php
	...
	class poloniex {
		...
		private function queryPublic(array $req = array()) {
			$uri = file_get_contents('https://poloniex.com/public?'.http_build_query($req, '', '&'));
		...
		public function get_recent_chart_data($pair, $second, $period) {
			return $this->query(
				array(
